//===-- Til64ISelLowering.h - rvex DAG Lowering Interface -----*- C++ -*-===//
//
...
#ifndef rvex_ISELLOWERING_H
#define rvex_ISELLOWERING_H
...
namespace llvm {
  namespace T64ISD {
    enum {
      ...
      //Other special instructions of rvex
      BITX,
      CRC32_32,
      CRC32_8,
      MM,
  ...
  //TODO: inlineasm support for rvex

  class rvexTargetLowering : public TargetLowering {
  public:
    rvexTargetLowering(TargetMachine &TM);
    ...
    //SDValue LowerFRAMEADDR(SDValue Op, SelectionDAG &DAG, bool isFrameAddrTaken) const;
